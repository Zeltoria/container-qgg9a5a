...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-qgg9a5a.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-qgg9a5a.containers.anotherwebservice.com/
...
```
git clone git@github.com:Zeltoria/container-qgg9a5a.git
cd container-qgg9a5a
```
...
```
docker attach container-qgg9a5a
```
